...
export class ToDoAjoutComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private toastr: ToastrService, private _ts: TodoService, private router: Router,private t :Title) {
    [
